...
#'
#' @description A \code{data.frame} with the data to plot the cellular strucutes.
#'
...
#' @title Plotting Coordinates for other organisms 
#'
#' @description A \code{list} with the coordinate data to plot the other organisms .
#'
